package org.muyie.framework.data.jpa.service;

import org.muyie.framework.data.jpa.service.filter.Filter;
import org.muyie.framework.data.jpa.service.filter.RangeFilter;
import org.muyie.framework.data.jpa.service.filter.StringFilter;
...
public abstract class QueryService<E> {
  ...
  /**
   * Generic method, which based on a Root&lt;E&gt; returns an Expression which type is the same as
