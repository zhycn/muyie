...
public class FloatFilter extends RangeFilter<Float> {
   ...
   * </p>
   *
   * @param filter a {@link org.muyie.framework.domain.service.filter.FloatFilter} object.
   */
   ...
   * </p>
   *
   * @return a {@link org.muyie.framework.domain.service.filter.FloatFilter} object.
   */
