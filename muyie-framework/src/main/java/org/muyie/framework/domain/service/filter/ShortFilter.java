...
public class ShortFilter extends RangeFilter<Short> {
   ...
   * </p>
   *
   * @param filter a {@link org.muyie.framework.domain.service.filter.ShortFilter} object.
   */
   ...
   * </p>
   *
   * @return a {@link org.muyie.framework.domain.service.filter.ShortFilter} object.
   */
