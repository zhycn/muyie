...
public class UUIDFilter extends Filter<UUID> {
   ...
   * </p>
   *
   * @param filter a {@link org.muyie.framework.domain.service.filter.UUIDFilter} object.
   */
   ...
   * </p>
   *
   * @return a {@link org.muyie.framework.domain.service.filter.UUIDFilter} object.
   */
