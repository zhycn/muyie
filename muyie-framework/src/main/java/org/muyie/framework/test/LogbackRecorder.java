 ...
 * the following.
 * <p>
 * {@code LogbackRecorder recorder = LogbackRecorder.forClass(TestedClass.class) .reset()
 * .capture(Level.WARN.name()); // do something that logs List<LogbackRecorder.Event> events =
 * recorder.release().play(); // perform assertions on the events }
 */
