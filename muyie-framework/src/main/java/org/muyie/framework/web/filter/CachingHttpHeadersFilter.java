...
public class CachingHttpHeadersFilter implements Filter {
   ...
   * </p>
   *
   * @param muyieProperties a {@link MuyieProperties} object.
   */
  public CachingHttpHeadersFilter(MuyieProperties muyieProperties) {
  ...
  public void init(FilterConfig filterConfig) throws ServletException {
    cacheTimeToLive =
      TimeUnit.DAYS.toMillis(muyieProperties.getHttp().getCache().getTimeToLiveInDays());
  }
