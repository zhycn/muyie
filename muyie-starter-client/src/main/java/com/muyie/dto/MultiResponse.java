...
public class MultiResponse<T> extends Response {
   ...
   * @param data      结果数据
   */
  private MultiResponse(@NonNull ErrorCode errorCode, @Nullable List<T> data) {
    super(errorCode);
    this.data = data;
  }
   ...
   * @return 结果
   */
  public static <T> MultiResponse<T> of(@NonNull ErrorCode errorCode, @Nullable List<T> data) {
   ...
   * @return 结果
   */
  public static <T> MultiResponse<T> of(@Nullable List<T> data) {
